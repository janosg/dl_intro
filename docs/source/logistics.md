...
If you are already signed up, please subscribe to the `dl-intro` stream.
...
You can tag one of us if you ask a question in a public channel and can send either one a direct message if you have a question that cannot be asked in a public channel.
...
+                                                                    +                                                                   +
+     `Instructor: Dr. Janoś Gabler <https://github.com/janosg>`_    +     `TA: Mariam Petrosyan <https://github.com/mpetrosian>`_       +
+--------------------------------------------------------------------+-------------------------------------------------------------------+
```
...
The grade is determined entirely by a final project of your choice.
...
A final project will be about as much work as two or three exercises.
...
If there is no simple way of producing all results or this way is not documented in the README, we will deduct points.
